...
from keras.utils import layer_utils, multi_gpu_model
...
def Multi_gpu_lstm_1d(input_shape = (10,8540), output_shape = 1, units_list = [2000,1000,500],return_seq = False):
    '''
...
def Multi_gpu_CNN(input_shape=(60,60,1), output_shape=3, filters_list=[32,16,8], data_format='channels_last'):
    '''
...
def Multi_gpu_ST_CNN(input_shape, extra_input_shape=None, output_shape=1, filters_list=[128,256,512], data_format='channels_last'):
    '''
    Input: A tensor, shape:(batch_size, width, height, channels)
    Output: A tensor,shape:(batch_size, 1) or (batch_size, time_length)
    input_shape : (time_length, number_features)
...
def Multi_gpu_simple_VGG(input_shape, extra_input_shape=None, output_shape=1, filters_list=[128,64,32], data_format='channels_last'):
    '''
    Input: A tensor, shape:(batch_size, width, height, channels)
    Output: A tensor,shape:(batch_size, 1) or (batch_size, time_length)
    input_shape : (time_length, number_features)
...
def Multi_gpu_ResNet(input_shape, extra_input_shape=None, gpu_number=1):
    X_input = Input(input_shape)
